    ...
    public partial class LoginAdmin : Form
    {
        ...
        public void logins()
        {
            try
            {
                ...
                {
                    conexion.Open();
                    using (SqlCommand cmd = new SqlCommand("SELECT Usuario, Contraseña FROM Administracion WHERE Usuario='" + txtuser.Text + "' AND Contraseña='" + txtpass.Text + "'", conexion))
                    {
