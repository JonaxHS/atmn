...
namespace SistemaSeguridad
{
	public partial class Movimientos : Form
	{
        ...
        public Movimientos(string text)
        {
        ...
        private void Button5_Click_1(object sender, EventArgs e)
        {
            ...
            abrirformhijo(new modificarMov());
